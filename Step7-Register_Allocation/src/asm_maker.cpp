...
void print_inter_node(threeAC_node * temp_node, string helpful_info) {
  cout<<";" << helpful_info << " Opcode: " << temp_node->op_value << "\tSrc1: " << temp_node->Rs << "\tSrc2: " << temp_node->Rt <<"\tDest: "<<temp_node->reg_dest<<"\tOp-Type: "<<temp_node->op_type<<"\n";
}
