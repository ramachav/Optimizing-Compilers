...
call_expr:         	id OPENPARENTHESIS expr_list CLOSEPARENTHESIS {
			...
			//delete pop_return_value;
			
			//delete temp_expr_list;
			//delete expr_list_list;
			$$ = call_expr_list;
			};
...
for_stmt:          	for_stmt_start OPENPARENTHESIS init_stmt SEMICOLON cond SEMICOLON incr_stmt CLOSEPARENTHESIS decl stmt_list for_stmt_end {
			...
			//delete init_stmt_list;
			//delete cond_list;
			//delete incr_stmt_list;
			//delete stmt_list_list;
			//delete temp_cond;
			//delete fresh_node1;
			//delete fresh_node2;
